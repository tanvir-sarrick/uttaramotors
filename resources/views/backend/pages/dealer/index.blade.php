                    ...
                    <div class="d-flex justify-content-start justify-content-md-end align-items-baseline">
                        <div class="dt-action-buttons d-flex flex-column align-items-start align-items-sm-center justify-content-sm-center pt-0 gap-sm-4 gap-sm-0 flex-sm-row">
                            <div class="dataTables_length mx-n2" id="DataTables_Table_0_length">
                                <label>
                                    <input type="text" id="filterData" class="form-control" placeholder="Search By Dealer Code/Name" style="width: 240px;" autocomplete="off">
                                </label>
                            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#createDealerBtn').click(function (e) {
                e.preventDefault();
                var downloadUrl = "{{ route('dashboard.dealer.create') }}";
