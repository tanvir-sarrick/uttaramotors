        ...
        <div class="col-12">
            <div class="card">
                <div class="card">
                    ...
                    <div class="row mx-3">
                        <form action="{{ route('dashboard.permission.update', $group_name) }}" method="POST">
                            @csrf
                            ...
                            <div class="add_item">
                                <div class="form-group row">
                                    <!--  Group Name Start !-->
                                    <div class="col-sm-12">
                                        <label for="example-text-input" class="">Group Name <span
                                                class="text-danger">*</span></label>
                                        <input class="form-control" type="text" name="group_name"
                                            value="{{ $group_name }}" id="example-text-input"
                                    ...
                                    @foreach ($all_permission as $permission)
                                        <div class="delete_whole_extra_item_add" id="delete_whole_extra_item_add"
                                            ...
                                            <div class="row">
                                                <div class="col-8 mt-2" style="">
                                                    <label for="example-text-input" class="">Permission Name <span
                                                            class="text-danger">*</span></label>
                                                    <input class="form-control mb-2" type="text" name="name[]"
                                                        value="{{ $permission->name }}" id="example-text-input"
                                                ...
                                                <div class="col-3 mt-4">
                                                    <span class="btn btn-success addeventmore" style="margin-top: 12px;"><i
                                                            class="fa fa-plus-circle"></i></span>
                                                    <span class="btn btn-danger removeeventmore"
                                                        style="margin-top: 12px;"><i class="fa fa-minus-circle"></i></span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="delete_whole_extra_item_add" id="delete_whole_extra_item_add">
                                        <div class="row">
                                            ...
                                            <div class="col-3 mt-3">
                                                <span class="btn btn-success addeventmore" style="margin-top: 12px;"><i
                                                        class="fa fa-plus-circle"></i></span>
                                                <span class="btn btn-danger removeeventmore" style="margin-top: 12px;"><i
