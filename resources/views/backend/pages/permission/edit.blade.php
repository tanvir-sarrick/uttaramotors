                    ...
                    <form action="{{ route('dashboard.permission.update', $group_name) }}" method="POST">
                        ...
                        <div class="add_item">
                            ...
                            @foreach ($all_permission as $permission)
                                <div class="delete_whole_extra_item_add" id="delete_whole_extra_item_add" style="width: -webkit-fill-available;">
                                    <div class="row">
                                        <div class="col-8 mt-2" style="margin-left: 17px;">
                                            <label for="example-text-input" class="">Permission Name <span class="text-danger">*</span></label>
                                                <input class="form-control mb-2" type="text" name="name[]" value="{{ $permission->name }}"
                                                id="example-text-input" placeholder="Enter Permission Nmae" >
                                            @error('name')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
