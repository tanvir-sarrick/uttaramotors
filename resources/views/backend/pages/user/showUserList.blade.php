        ...
        @if ($users->count() > 0)
            ...
            @foreach ($users as $user)
                <tr>
                    ...
                    <td>
                        <div class="">
                            <a href="{{ route('dashboard.user.edit', $user->id) }}" class="btn btn-sm btn-info btn-text-secondary rounded-pill waves-effect btn-icon">
                                <i class="fa-solid fa-pen-to-square"></i>
                            </a>
                            <button type="button" class="btn btn-sm btn-danger btn-text-secondary rounded-pill waves-effect btn-icon softDeleteData" data-url="{{ route('dashboard.user.softdelete', $user->id) }}">
