                    ...
                    <div class="dataList" id="dataList">
                        <div class="p-4">
                            @if ($invoices->count() <= 0)
                                ...
                                <div class="card shadow-sm border-0 bg-label-warning mb-4">
                                    <div class="card-body">
                                        ...
                                        <ul class="mb-0 ps-3">
                                            <li class="mb-1">Some quick example text to build on the card title and make
                                                up.</li>
                                            <li class="mb-1">Some quick example text to build on the card title and make
                                                up.</li>
                                            <li class="mb-1">Some quick example text to build on the card title and make
                            ...
                            <div class="card shadow-sm border-0">
                                <div class="card-body">
                                    @if ($invoices->count() <= 0)
                                        <form action="{{ route('invoices.import') }}" method="POST"
                                            ...
                                            <div class="row g-3">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <select class="form-select" id="dealerSelect" name="dealer_id" required>
                                                        <option value="" disabled selected>-- Choose a Dealer --
                                                        </option>
