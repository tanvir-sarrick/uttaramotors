    ...
    <div class="col-12">
        <div class="card">
            <div class="card">
                ...
                <div class="row mx-3">
                    <form class="form" action="{{ route('dashboard.role.store') }}" method="post">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-6" style="background-color: #605daf47;">
                                <label class="my-2 control-label">Permissions</label>
                            </div>
                            <div class="col-6" style="background-color: #605daf47;">
                        ...
                        <div class="row">
                            @php $i=1; @endphp
                                ...
                                <div class="col-lg-4 col-12 mb-3">
                                    ...
                                    @endphp
                                    <div class="col-12">
                                        <div class="checkbox my-2" style="text-align:center;">
                                            <div class="custom-control custom-checkbox">
